import { iphonerepair, smartphonerepair, ipadtabletrepair, macbookrepair, laptoprepair, logicboardrepair, liquiddamangerepair, playstationrepair, nintendoswitchrepair, xboxrepair } from "../assets/services_img";
...
export const repairs = [
    ...
    },
    {
        ...
        description: "Logic Board failure can be a challenging task to take care of. Here, at MaxRepair we can deal with it!",
    ...
    },
    {
        ...
        listofconsols: [
            ...
            },
            {
                ...
                description: "At MAX REPAIR, you can repair your Switch, Switch Light, Wii U, Wii the same day",
                listTitle: "We can fix:",
                listofrepairs: [
                    {
                        id: 1,
                        repair: "Software issue, not booting up issue, not powering on issue.",
                    },
                    {
                        id: 2,
                        repair: "HDMI replacement, USB charging port repair",
                    },
                    {
                        id: 3,
                        repair: "Touchscreen replacement, LCD replacement",
                    },
                    {
                        id: 4,
                        repair: "Overheating and getting laggy, freezing when playing games or doing some heavy stuff",
                    ...
                    {
                        id: 5,
                        repair: "No power issue (battery replacement, power supply replacement)",
                    },
                    {
                        id: 6,
                        repair: "Game reading issue repair (game reader, lens/laser/disk drive replacement)",
                    },
                    {
                        id: 7,
                        repair: "Controller not connecting to the console repair, WIFI repair",
                    ...
                    {
                        id: 9,
                        repair: "Controller repair (buttons not working, not charging)",
                    },
                ],
                inquiry: [
                    {
                ...
                image: nintendoswitchrepair,
            },
            {
                id: 'xbox',
                title: "XBOX Repair",
                description: "At MAX REPAIR, you can repair your XBOX the same day",
                listTitle: "We can fix:",
                listofrepairs: [
                    {
                        id: 1,
