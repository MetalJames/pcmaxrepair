...
const BrandsWeCanFix = () => {
    return (
        <div className='flex flex-col justify-center items-center sm:px-24 px-6 sm:py-16 py-6 bg-[#f0f8ff]'>
            <h2 className='font-poppins font-semibold xs:text-[48px] text-[40px] xs:leading-[76.8px] leading-[66.8px] w-full text-center pb-4'>Brands we can fix</h2>
            <div className='flex flex-row flex-wrap sm:justify-center justify-around sm:w-2/3 w-full sm:px-10 p-0 ]'>
