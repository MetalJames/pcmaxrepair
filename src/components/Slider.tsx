                        ...
                        ${slide.id === 'repair_logicboard' || slide.id === 'repair_console' ? 'sm:flex-row-reverse flex-col-reverse' : 'sm:flex-row flex-col-reverse'}`}>
                            <div className='flex flex-col w-full justify-around items-center'>
                                {slide.id === 'repair_iphone' ?
                                    <h1 className='font-poppins font-semibold xs:text-[48px] text-[32px] xs:leading-[76.8px] leading-[32px] sm:w-[75%] w-[80%] sm:py-0 py-4 text-center'>
                                        {slide.title}
                                    </h1>
                                    :
                                    <h2 className='font-poppins font-semibold xs:text-[48px] text-[32px] xs:leading-[76.8px] leading-[32px] sm:w-[75%] w-[80%] sm:py-0 py-4 text-center'>
                                        {slide.title}
                                    </h2>
                                }
